...
|----------|---------------|
| `01_clip_from_scratch/01_clip_from_scratch.ipynb` | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Gaurav14cs17/Multimodal-Deep-Learning/blob/main/02_Vision_Language_Models/01_clip_from_scratch/01_clip_from_scratch.ipynb) |
| `02_image_captioning/02_image_captioning.ipynb` | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Gaurav14cs17/Multimodal-Deep-Learning/blob/main/02_Vision_Language_Models/02_image_captioning/02_image_captioning.ipynb) |
| `03_visual_question_answering/03_visual_question_answering.ipynb` | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Gaurav14cs17/Multimodal-Deep-Learning/blob/main/02_Vision_Language_Models/03_visual_question_answering/03_visual_question_answering.ipynb) |
...
## Notebook 1: `01_clip_from_scratch/01_clip_from_scratch.ipynb` [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Gaurav14cs17/Multimodal-Deep-Learning/blob/main/02_Vision_Language_Models/01_clip_from_scratch/01_clip_from_scratch.ipynb)
...
## Notebook 2: `02_image_captioning/02_image_captioning.ipynb` [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Gaurav14cs17/Multimodal-Deep-Learning/blob/main/02_Vision_Language_Models/02_image_captioning/02_image_captioning.ipynb)
...
By the chain rule of probability, the joint distribution factorizes into next-token predictions, each conditioned on the image $I$ and all prior tokens $(y_1, \ldots, y_{t-1})$.

At step $t$, the model outputs a distribution over vocabulary $\mathcal{V}$:

$$P(y_t = w \mid y_1, \ldots, y_{t-1},\, I) = \text{softmax}(\mathbf{W}_{\text{out}} \mathbf{h}_t + \mathbf{b})_w, \qquad w \in \mathcal{V}$$
...
$$y_t = \arg\max_{w \in \mathcal{V}} P(w \mid y_1, \ldots, y_{t-1},\, I)$$
...
$$\text{score}(\mathbf{y}) = \sum_{t=1}^{T} \log P(y_t \mid y_1, \ldots, y_{t-1},\, I)$$
...
$$P'(w) = \frac{P(w \mid y_1, \ldots, y_{t-1},\, I)}{\sum_{w' \in \text{Top-}k} P(w' \mid y_1, \ldots, y_{t-1},\, I)}, \quad w \in \text{Top-}k$$
...
$$V_p = \min \left\lbrace V' \subseteq \mathcal{V} : \sum_{w \in V'} P(w \mid y_1, \ldots, y_{t-1},\, I) \geq p \right\rbrace$$
...
## Notebook 3: `03_visual_question_answering/03_visual_question_answering.ipynb` [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Gaurav14cs17/Multimodal-Deep-Learning/blob/main/02_Vision_Language_Models/03_visual_question_answering/03_visual_question_answering.ipynb)
...
|-------|---------------|-------------------|
| **CLIP** | $\mathcal{L} = -\frac{1}{2N}\sum_i \left[\log \frac{e^{S_{ii}/\tau}}{\sum_j e^{S_{ij}/\tau}} + \log \frac{e^{S_{ii}/\tau}}{\sum_j e^{S_{ji}/\tau}}\right]$ | $(I, T) \to s \in \mathbb{R}$ |
| **Captioning** | $\mathcal{L} = -\displaystyle\sum_{t=1}^{T} \log P(y_t \mid y_{1:t-1}, I)$ | $I \to (y_1, \ldots, y_T)$ |
...
**[03_Training_Strategies/01_contrastive_learning/01_contrastive_learning.ipynb](../03_Training_Strategies/01_contrastive_learning/01_contrastive_learning.ipynb)** [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Gaurav14cs17/Multimodal-Deep-Learning/blob/main/03_Training_Strategies/01_contrastive_learning/01_contrastive_learning.ipynb) — this is where the real "how to train" learning begins.
